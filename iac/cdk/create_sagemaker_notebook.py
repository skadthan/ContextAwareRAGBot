...
class CreateSageMakerNotebook(Construct):
    ...
    def __init__(self, scope: Construct, construct_id: str, props: dict, **kwargs) -> None:
        ...
        notebook_instance_lifecycle_config = sagemaker.CfnNotebookInstanceLifecycleConfig(self, "InstanceLifecycleConfig",
        ...
        sagemaker.CfnNotebookInstance(self, "Instance",
        ...
        # Create a policy to allow BatchGetCollection API on OpenSearch 
